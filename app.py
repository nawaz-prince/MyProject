...
app.layout = html.Div(
    [
        html.Div(
            [
                # Navigation
                html.P("Welcome to the Stock Predictor!", className="start"),
                html.Div([
...
def update_data(n, val):  # inpur parameter(s)
    if n == None:
        return "Hey there! Please enter a legitimate stock code to get details.", "https://images.livemint.com/img/2023/02/10/600x338/Stock_market_news_1675988415033_1675988415210_1675988415210.jpg", "Stocks", None, None, None
        # raise PreventUpdate
    else:
        if val == None:
            raise PreventUpdate
